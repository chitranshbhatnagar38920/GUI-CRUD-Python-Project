...
rootframe = Tk() 
rootframe.title('Chitransh Software Management System') 
welcometext = "Hello There!\n\nWelcome to Chitransh Pharmacy Soft Inc."
...
#BACKGROUND IMAGE
img = Image.open("hospitalbg.jpg") #read the image
...
bgimglbl = Label(rootframe, compound=tk.CENTER, text=welcometext, bd=-10, font='Helvetica 30 bold', fg='#af1f1f', image=bgimg)
...
'''
welcometext1 = "...A Program That Allows the Unimaginable..."
welcomelbl1 = Label(rootframe, height=2, text=welcometext1, font='Helvetica 18 bold', bg= "#af1f1f")
welcomelbl1.grid(row=0, column=0, sticky='NEW') #place it in first row, first column of the main root window; centered by default
'''
...
logoimg=Image.open('opulent_logo.jpg')# Load the image
...
welcometext2 = "Contact: +91-9564733916\nBuy more of Chitransh's courses on abc.com\n"
welcomelbl2 = Label(rootframe, height=3
                    , text=welcometext2, justify="left", font='"Bodoni MT" 15', bg= "black")
welcomelbl2.config(fg="white", justify="left")
welcomelbl2.grid(row=0, column=0, sticky='SEW') #place it in first row, first column of the main root window; centered by default
#---------------------------------------------
#GUI - App Menu
